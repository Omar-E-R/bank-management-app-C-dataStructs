...
// 		if(addVille(liste_data, count)!=EXIT_SUCCESS)
// 		{
...
// 		if(addAgence(ville->liste_agences, newAgence)!=EXIT_SUCCESS)
// 		{
...
// 	Compte compte;
// 	if(agence->liste_compte==NULL)
// 	{
// 		agence->liste_compte=init_liste_compte();
// 	}

// 	data = json_object_get(root, "liste_compte");

// 	/* verifying that "liste_compte" is an array */
// 	if (!json_is_array(data))
// 	{
// 		fprintf(stderr, "error: the liste_compte element of this data is not an array\n");
// 		json_decref(root);
// 		return EXIT_FAILURE;
// 	}
...
// 		/*Adding it to the data stack*/
// 		if (addCompte(agence->liste_compte, compte) != EXIT_SUCCESS)
// 		{
...
// 	Client client;
// 	if (agence->liste_client == NULL)
// 	{
// 		agence->liste_client = init_liste_client();
// 	}

// 	data = json_object_get(root, "liste_client");

// 	/* verifying that "liste_client" is an array */
// 	if (!json_is_array(data))
// 	{
// 		fprintf(stderr, "error: the liste_client element of this data is not an array\n");
// 		json_decref(root);
// 		return EXIT_FAILURE;
// 	}
...
// 		/*Adding it to the data stack*/
// 		if (addClient(agence->liste_client, client) != EXIT_SUCCESS)
// 		{
